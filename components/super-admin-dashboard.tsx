...
import { ArrowUpDown, BarChart3, CheckCircle, Clock, Hotel, LogOut, Settings, Users } from "lucide-react"
                  ...
                  >
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={mockData.growthData[municipality]}>
                        ...
                        <Line type="monotone" dataKey="accommodations" stroke="var(--color-accommodations)" strokeWidth={2} />
                      </LineChart>
                    </ResponsiveContainer>
                  </ChartContainer>
                </CardContent>
